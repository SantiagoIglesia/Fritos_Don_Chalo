document.addEventListener("DOMContentLoaded", function() {
  ...
  var id = urlParams.get('id_provider');
  ...
  document.getElementById("crearProductoProveedorBoton").addEventListener('click', function(event){
    event.preventDefault();
    ...
    var idProveedorValue = document.getElementById('id_proveedor').value;
    var idProveedorInput = document.getElementById('id_proveedor');
    var nombreProveedorValue = document.getElementById('nombre_proveedor').value;
    var nombreProveedorInput = document.getElementById('nombre_proveedor');
    ...
    if(nombreValue.length == 0) {
      ...
      destinoInput.focus();
    } else if(idProveedorValue != id) {
      alert('ID de proveedor inválido.');
      idProveedorInput.focus();
    } else if(idProveedorValue.length == 0) {
      alert('ID de proveedor inválido.');
      idProveedorInput.focus();
    } else if(!validacionNumeros.test(idProveedorValue)) {
      alert('ID de proveedor inválido.');
      idProveedorInput.focus();
    } else if(nombreProveedorValue != nombre) {
      alert('Nombre de proveedor inválido.');
      nombreProveedorInput.focus();
      console.log(nombreProveedorValue);
    } else if(nombreProveedorValue.length == 0) {
      alert('Nombre de proveedor inválido.');
      nombreProveedorInput.focus();
    } else if(!validacionLetras.test(nombreProveedorValue)) {
      alert('Nombre de proveedor inválido.');
      nombreProveedorInput.focus();
